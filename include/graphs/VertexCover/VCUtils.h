...
public:
    ...
    /**
     * @return true if [mis] is a maximal independent set in [V], false otherwise
     */
    ...
    /**
     * Searches for a minimum VC of given graph [V] using NuMVC / FastVC for given time in milliseconds.
     * @param init_vc some vertex cover of V, if it is known. It may speed
     * @reutrn found vertex cover
     */
